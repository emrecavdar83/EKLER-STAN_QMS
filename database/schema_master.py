...
def _map_perf_tablolar(pk, ts, ine):
    return [
        ('map_vardiya', f"CREATE TABLE {ine} map_vardiya (id {pk}, tarih TEXT NOT NULL, makina_no TEXT NOT NULL DEFAULT 'MAP-01', urun_adi TEXT, vardiya_no INTEGER NOT NULL, baslangic_saati TEXT NOT NULL, bitis_saati TEXT, operator_adi TEXT NOT NULL, vardiya_sefi TEXT, besleme_kisi TEXT, kasalama_kisi TEXT, hedef_hiz_paket_dk FLOAT, gerceklesen_uretim INTEGER DEFAULT 0, acan_kullanici_id INTEGER, kapatan_kullanici_id INTEGER, durum TEXT DEFAULT 'ACIK', notlar TEXT, olusturma_ts {ts}, guncelleme_ts {ts})"),
        ('map_vardiya_urun_gecmisi', f"CREATE TABLE {ine} map_vardiya_urun_gecmisi (id {pk}, vardiya_id INTEGER NOT NULL REFERENCES map_vardiya(id), urun_adi TEXT NOT NULL, baslangic_ts TEXT NOT NULL, bitis_ts TEXT NOT NULL, uretim_miktari INTEGER DEFAULT 0, degistiren_kullanici_id INTEGER, olusturma_ts {ts})"),

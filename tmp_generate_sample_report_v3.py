...
<head>
<meta charset="UTF-8">
<title>Soğuk Oda Raporu Taslağı (V3 - Takip Ölçümlü)</title>
<style>
  ...
  .bg-yellow { background-color: #fff8e1; color: #f57f17; border: 1px solid #ffe082; }
...
<div class="no-print" style="text-align:center; padding: 10px; background: #e3f2fd; color: #1565c0; border: 1px solid #90caf9; border-radius: 6px; margin-bottom: 20px; font-weight: bold;">
    ℹ️ V3 Taslağı: Sapma sonrasında yapılan "Telafi/Takip Ölçümü" analizi tabloya ve rapora entegre edildi.
</div>
...
<div class="a4-container">
  ...
  <div class="info-bar">
    ...
    <div class="info-item">
      ...
      <span class="info-value" style="color:#c62828;">⚠️ 1 Sapma (1 Takip/DÖF ilekapatıldı)</span>
    </div>
  </div>
  ...
  <table>
    <thead>
      <tr>
        <th width="15%">Ölçüm Aralığı / Türü</th>
    ...
    <tbody>
      <tr>
        ...
        <td>Ayşegül Tetik</td>
        <td style='font-size:8px; color:#555;'>Tarayıcı: OTO <br> Log: 08:15:32</td>
      </tr>
      <tr>
        <td>12:00 - 13:00</td>
        <td><b>12:05</b></td>
        ...
        <td><span class="badge bg-green">Uygun</span></td>
        <td>Ayşegül Tetik</td>
        <td style='font-size:8px; color:#555;'>Tarayıcı: OTO <br> Log: 12:05:10</td>
      </tr>
      <tr>
        <td>16:00 - 17:00</td>
        ...
        <td>Ayşegül Tetik</td>
        <td style='font-size:8px; color:#555;'>Mobil: MANUEL <br> Log: 16:42:05</td>
      </tr>
      <tr style="background-color: #f1f8e9;">
        <td style="color:#2e7d32;"><i>Takip Ölçümü (DÖF)</i></td>
        <td><b>17:15</b></td>
        <td>-18.5 °C</td>
        <td><span class="badge bg-green" style="background-color:#c8e6c9;">Düzeltildi</span></td>
        <td>Ayşegül Tetik</td>
        <td style='font-size:8px; color:#555;'>Mobil: TAKİP <br> Log: 17:15:22</td>
      </tr>
      <tr>
        <td>20:00 - 21:00</td>
        <td>-</td>
  ...
  <div class="deviation-box">
    <div class="deviation-title">🚨 Kritik Sapma ve Takip(DÖF) Raporu</div>
    <ul class="deviation-list">
      <li>
        <b>16:00 - 17:00</b> periyodu ölçümünde (Kayıt: <span class="val-err">16:42</span>), olması gereken maksimum <span class="val-orig">-18.0 °C</span> limiti aşılarak <span class="val-err">-16.4 °C</span> ölçülmüştür. İşlem Yetkilisi: Ayşegül Tetik.
        <span class="follow-up-text">↳ Düzeltici Faaliyet: Sapmadan 33 dakika sonra (17:15) yapılan <b>takip ölçümünde</b> sıcaklığın -18.5 °C'ye düşerek limitler dahiline girdiği (Uygun/Düzeltildi) tespit edilmiştir.</span>
      </li>
    </ul>
  </div>
  ...
  <div class="footer">
    ...
    with open('ornek_soguk_oda_coklu_sayfa.html', 'w', encoding='utf-8') as f:
        f.write(sample_html)
    print("Örnek HTML dosyası v3 oluşturuldu.")
